...
public class NoticeModify extends AsyncTask<Void,Void,String> {
    int id;
    String flag, member_id, board_title, board_content, board_filepath;

    public NoticeModify(int id, String flag, String member_id, String board_title, String board_content) {
        this.id = id;
        this.flag = flag;
