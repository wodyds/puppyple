...
public class NaverJoinInsert extends AsyncTask<Void, Void, String> {
    ...
    String member_id, member_pw, member_phone, member_email, member_nickname, member_naver;

    // 카카오용
    public NaverJoinInsert(String member_id, String member_pw, String member_phone,String member_email, String member_nickname, String member_naver){
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            builder.addTextBody("member_naver", member_naver, ContentType.create("Multipart/related", "UTF-8"));

            //20211111파일을 전송할때 추가하기 (pet info같은경우에는 추가해야할 부분 _JP

            //전송
            //전송 url: 우리가 수정해줘야하는 부분 anJoin 부분
            String postURL = ipConfig + "/bteam/and_join_naver";
            //그래도 사용 복, 붙
