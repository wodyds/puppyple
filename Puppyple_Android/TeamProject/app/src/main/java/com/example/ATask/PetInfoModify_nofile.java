...
public class PetInfoModify_nofile extends AsyncTask<Void, Void, String> {


    String pet_id, member_id, pet_name, pet_age, pet_breed, pet_weight, pet_gender, pet_nuetering, pet_filepath;

    public PetInfoModify_nofile(String pet_id, String member_id, String pet_name, String pet_age, String pet_breed, String pet_weight, String pet_gender, String pet_nuetering) {
        this.pet_id = pet_id;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/bteam/and_petModify_Nofile";
            //그래도 사용 복, 붙
