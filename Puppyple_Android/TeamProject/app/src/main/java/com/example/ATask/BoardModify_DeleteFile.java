...
public class BoardModify_DeleteFile extends AsyncTask<Void,Void,String> {
    int id;

    public BoardModify_DeleteFile(int id) {
        this.id = id;
    }
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_board_Modify_Deletefile";
            //그래도 사용 복, 붙
