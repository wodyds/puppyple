...
public class MyBoardListSelect extends AsyncTask <Void, Void, Void> {
    ...
    //11/22/2021
    public MyBoardListSelect(String member_id) {
        this.member_id = member_id;
    }

    public MyBoardListSelect(ArrayList<BoardDTO> dtos, BoardListViewAdapter adapter, String member_id) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_My";
            //그래도 사용 복, 붙
