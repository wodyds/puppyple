...
public class Inquiry_Register extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        reg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (state.equals("1")) {
                    Toast.makeText(Inquiry_Register.this,
                            "1:1문의 등록 완료", Toast.LENGTH_SHORT).show();

                    finish();
                } else {
                    Toast.makeText(Inquiry_Register.this,
                            "1:1문의 등록에 실패했습니다. 다시 시도해 주세요.", Toast.LENGTH_SHORT).show();
                }
