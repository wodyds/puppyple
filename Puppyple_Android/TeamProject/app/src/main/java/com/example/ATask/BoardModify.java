...
public class BoardModify extends AsyncTask<Void,Void,String> {
    int id;
    String flag,member_id,board_title,board_content,board_filepath;

    public BoardModify(int id, String flag, String member_id, String board_title, String board_content, String board_filepath){
        this.id = id;
        this.flag = flag;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            builder.addPart("board_filepath", new FileBody(new File(board_filepath)));

            //전송
            //전송 url : 우리가 수정해줘야하는 부분 anJoin 부분
            String postURL = ipConfig + "/bteam/and_board_Modify";
            //그래도 사용 복, 붙
