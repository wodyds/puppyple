...
public class PetListSelect extends AsyncTask <Void, Void, Void> {
    ...
    public PetListSelect(String member_id, ArrayList<PetDTO> dtos){
        this.member_id = member_id;
        this.dtos = dtos;
    }

    public PetListSelect(String member_id, ArrayList<PetDTO> dtos, PetListViewAdapter adapter) {
        this.member_id = member_id;
        this.dtos = dtos;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_petList";
            //그래도 사용 복, 붙
