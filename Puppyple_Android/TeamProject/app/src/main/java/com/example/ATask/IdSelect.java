...
public class IdSelect extends AsyncTask<Void, Void, Void> {
    String member_email;
    ArrayList<MemberDTO> dtos;

    public IdSelect(String member_email, ArrayList<MemberDTO> dtos){
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_id_find";
            //그래도 사용 복, 붙
