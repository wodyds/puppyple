...
public class MemberModify extends AsyncTask<Void, Void, String> {
    ...
    public MemberModify(String member_id, String member_pw,
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/bteam/and_memberModify";
            //그래도 사용 복, 붙
