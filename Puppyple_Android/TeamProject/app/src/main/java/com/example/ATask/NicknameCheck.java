...
public class NicknameCheck extends AsyncTask<Void, Void, String> {

    //무조건 생성자를 만들어서 데이터를 받는다.
    String member_nickname;

    public NicknameCheck(String member_nickname) {
    ...
    protected String doInBackground(Void... voids) {
        try{
            ...
            Log.d(String.valueOf(this), "닉네임중복: " + member_nickname);

            //전송
            //전송 url: 우리가 수정해줘야하는 부분 anJoin 부분
            String postURL = ipConfig + "/bteam/and_nickChk";
            //그래도 사용 복, 붙
