...
import com.example.community.BoardCommentListViewAdapter;
...
public class BoardCommentListSelect extends AsyncTask<Void,Void,Void>{
    private static final String TAG = "main:BoardComment";
    ...
    String member_id, pid;



    //11/22/2021
    public BoardCommentListSelect(String member_id) {
        this.member_id = member_id;
    }

    public BoardCommentListSelect(String pid, ArrayList<BoardCommentDTO> dtos, BoardCommentListViewAdapter adapter) {
        this.pid = pid;
        this.dtos = dtos;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardComment_List";
            //그래도 사용 복, 붙
    ...
    public BoardCommentDTO readMessage(JsonReader reader) throws IOException {
        int id = 0;
        String pid = "";
        String member_id = "";
        String content = "";
        ...
        return new BoardCommentDTO(id,pid,member_id, content, writedate,member_nickname);
    }
