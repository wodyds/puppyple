...
public class TradeBoardListSelect extends AsyncTask <Void, Void, Void> {
    ...
    //11/22/2021
    public TradeBoardListSelect(String member_id) {
        this.member_id = member_id;
    }

    public TradeBoardListSelect(ArrayList<BoardDTO> dtos, BoardListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_Trade";
            //그래도 사용 복, 붙
