...
import com.example.ATask.KakaoJoinInsert;
...
public class KakaoPlus extends AppCompatActivity {
    private static final String TAG = "main:KakaoPlus";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_nick_chk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("0")) {
                    Toast.makeText(KakaoPlus.this,
                            "사용가능한 닉네임입니다. 계속 진행해주세요.", Toast.LENGTH_SHORT).show();
                    AlertDialog.Builder msgIdChk = new AlertDialog.Builder(KakaoPlus.this)
                            .setTitle("닉네임 중복검사")
        ...
        kakao_add_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String member_kakao = dto.getMember_kakao();
                String member_admin = dto.getMember_admin();

                Log.d(TAG, "닉네임은?: "+member_nickname);
                Log.d(TAG, "전화번호는?: "+member_phone);
                KakaoJoinInsert joinInsert = new KakaoJoinInsert(member_id, member_pw, member_phone,member_email, member_nickname, member_kakao,member_admin);
                try {
                ...
                if(state.equals("1")) {
                    Toast.makeText(KakaoPlus.this,
                            "정상적으로 카카오정보를 활용하여 회원가입이 되었습니다.", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(KakaoPlus.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }else {
                    Toast.makeText(KakaoPlus.this,
                            "카카오 정보를 활용한 회원가입에 실패했습니다. 다시 시도해 주세요.", Toast.LENGTH_SHORT).show();
                }
