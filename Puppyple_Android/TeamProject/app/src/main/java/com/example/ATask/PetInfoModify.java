...
public class PetInfoModify extends AsyncTask<Void, Void, String> {


    String pet_id, member_id, pet_name, pet_age, pet_breed, pet_weight, pet_gender, pet_nuetering, pet_filepath;

    public PetInfoModify(String pet_id, String member_id, String pet_name, String pet_age, String pet_breed, String pet_weight, String pet_gender, String pet_nuetering, String pet_filepath) {
        this.pet_id = pet_id;
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/bteam/and_petModify";
            //그래도 사용 복, 붙
