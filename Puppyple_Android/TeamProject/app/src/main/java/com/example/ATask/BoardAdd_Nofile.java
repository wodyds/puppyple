...
public class BoardAdd_Nofile extends AsyncTask<Void,Void,String> {
    String flag, member_id, board_title, board_content;

    public BoardAdd_Nofile(String flag, String member_id, String board_title, String board_content) {
        this.flag = flag;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_board_Add_Nofile";
            //그래도 사용 복, 붙
