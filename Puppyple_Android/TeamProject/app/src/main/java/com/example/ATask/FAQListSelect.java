...
public class FAQListSelect extends AsyncTask<Void, Void, Void> {
    ...
    public FAQListSelect(ArrayList<BoardDTO> dtos) {
        this.dtos = dtos;
    }

    public FAQListSelect(ArrayList<BoardDTO> dtos, NoticeListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_FAQ";
            //그래도 사용 복, 붙
