...
public class AdminInquiryListSelect extends AsyncTask<Void, Void, Void> {
    ...
    public AdminInquiryListSelect(ArrayList<BoardDTO> dtos, InquiryListViewAdapter adapter){
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_Inquiry_admin";
            //그래도 사용 복, 붙
