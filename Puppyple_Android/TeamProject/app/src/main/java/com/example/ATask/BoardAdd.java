...
public class BoardAdd extends AsyncTask<Void,Void,String> {

    String flag,member_id,board_title,board_content,board_filepath;

    public BoardAdd(String flag, String member_id, String board_title, String board_content, String board_filepath){
        this.flag = flag;
    ...
    protected String doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_board_Add";
            //그래도 사용 복, 붙
