...
public class MainBoardListSelect extends AsyncTask <Void, Void, Void> {
    ...
    //11/22/2021
    public MainBoardListSelect(String member_id) {
        this.member_id = member_id;
    }

    public MainBoardListSelect(ArrayList<BoardDTO> dtos, MainBoardListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_MainBoardList_All";
            //그래도 사용 복, 붙
    ...
    public BoardDTO readMessage(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            if (readStr.equals("id")) {
                ...
                board_filename = ipConfig + "/bteam/resources/upload/" + reader.nextString();
