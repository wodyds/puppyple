...
public class FreeBoardListSelect extends AsyncTask <Void, Void, Void> {
    ...
    //11/22/2021
    public FreeBoardListSelect(String member_id) {
        this.member_id = member_id;
    }

    public FreeBoardListSelect(ArrayList<BoardDTO> dtos, BoardListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_Free";
            //그래도 사용 복, 붙
