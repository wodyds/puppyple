...
import com.example.option.InquiryListViewAdapter;
...
public class InquiryListSelect extends AsyncTask<Void, Void, Void> {
    ...
    public InquiryListSelect(ArrayList<BoardDTO> dtos, InquiryListViewAdapter adapter, String member_id){
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_Inquiry";
            //그래도 사용 복, 붙
