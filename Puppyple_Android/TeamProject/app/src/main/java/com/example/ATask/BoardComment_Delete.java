...
public class BoardComment_Delete extends AsyncTask<Void,Void,String> {

    String id;

    public BoardComment_Delete(String member_id){
        this.id = member_id;
    }
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/bteam/and_board_comment_Delete";
            //그래도 사용 복, 붙
