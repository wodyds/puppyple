...
public class EventListSelect extends AsyncTask <Void, Void, Void> {
    ...
    public EventListSelect(ArrayList<BoardDTO> dtos, NoticeListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_Event";
            //그래도 사용 복, 붙
