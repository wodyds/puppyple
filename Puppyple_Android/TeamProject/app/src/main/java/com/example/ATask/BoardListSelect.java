...
public class BoardListSelect extends AsyncTask <Void, Void, Void> {
    ...
    //11/22/2021
    public BoardListSelect(String member_id) {
        this.member_id = member_id;
    }

    public BoardListSelect(ArrayList<BoardDTO> dtos, BoardListViewAdapter adapter) {
        this.dtos = dtos;
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_BoardList_All";
            //그래도 사용 복, 붙
