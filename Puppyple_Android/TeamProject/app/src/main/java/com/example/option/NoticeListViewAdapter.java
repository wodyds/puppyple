...
public class NoticeListViewAdapter extends BaseAdapter {
    ...
    public NoticeListViewAdapter(Context context, ArrayList<BoardDTO> dtos) {
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            //없기때문에 화면을 생성한다.
            convertView = inflater.inflate(R.layout.option_notice_view,
                    parent, false);

            NoticeListViewHolder = new NoticeListViewAdapter.NoticeListViewHolder();

            //생성한 곳에 petListViewHolder에 있는 tvpetname과 singerview.xml에 있는 것과
            //tvpet과 연결을시켜준다.
            //붙인 화면과 아래에 생성한 뷰홀더를 연결한다.

            NoticeListViewHolder.notice_tvTitle = convertView.findViewById(R.id.notice_tvTitle);
            NoticeListViewHolder.notice_tvContent = convertView.findViewById(R.id.notice_tvContent);
            convertView.setTag(NoticeListViewHolder);

        }else {//캐시된 뷰가 있을 경우 그냥 거기에 getTag로 넣어준다는 의미

            NoticeListViewHolder = (NoticeListViewAdapter.NoticeListViewHolder) convertView.getTag();
        ...
        String board_contents = dto.getBoard_content();


        NoticeListViewHolder.notice_tvTitle.setText(board_title);
        NoticeListViewHolder.notice_tvContent.setText(board_contents);
    ...
    public class NoticeListViewHolder {
        public TextView notice_tvTitle, notice_tvContent;
    }
}
