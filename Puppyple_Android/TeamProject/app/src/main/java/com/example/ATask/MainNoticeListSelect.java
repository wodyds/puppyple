...
public class MainNoticeListSelect extends AsyncTask<Void, Void, Void> {
    ...
    MainBoardListViewAdapter adapter;
    String member_id;


    //11/22/2021
    public MainNoticeListSelect(String member_id) {
        this.member_id = member_id;
    }

    public MainNoticeListSelect(ArrayList<BoardDTO> dtos/*, NoticeListViewAdapter adapter*/) {
        this.dtos = dtos;
//        this.adapter = adapter;
    }

    public MainNoticeListSelect(ArrayList<BoardDTO> dtos, MainBoardListViewAdapter adapter) {
        this.dtos = dtos;
        this.adapter = adapter;
    }
...
//        }
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/bteam/and_MainBoardList_Notice";
            //그래도 사용 복, 붙
