...
<link rel="stylesheet" href="css/find_pw_check.css">
		...
		<div>
			<div>
				...
				<c:if test="${pw eq null }">
					...
					<div id="search_id">
						<div class="find_btn">
							<a href="member" class="btn_submit">회원가입</a> <a
								href="id_find.find" class="btn_cancle">아이디 찾기</a> <a
								href="pw_find.find" class="btn_cancle">비밀번호 찾기</a>
						</div>
					</div>
				</c:if>
			</div>
