...
<body>
	<div id="new_content_wrap">
		...
		<form action="insert.faq" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<th>제목</th>
				...
				<tr>
					...
					<td class='left'><label> <input type="file"
							id='attach-file' name="file" /> <a> <img
								src="imgs/select.png" class="file-img"
								style="padding-left: 13px;"></a>
		...
		<div class="button">
			...
			<a class='btn-empty' href='list.faq'>취소</a>
		</div>
