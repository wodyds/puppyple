...
<body>
	<div id="content_wrap">
		<div class="notice_title_div">
			<h1 class="title">
				FAQ<span class="small_title"><span class="small_title_l">|</span>faq</span>
			</h1>
		</div>
				...
				<div class="list_btn2">
					<c:if
						...
						<a class="btn-fill" id="news_btn-modify"
							onclick=" $('form').attr('action', 'modify.faq');
						$('form').submit()">글
							수정</a>
						<a class="btn-fill" id="news_btn-delete"
							onclick=" if(confirm('정말 삭제하시겠습니까?')) { href='delete.faq?id=${vo.id }'} ">글
							삭제</a>
					</c:if>
				</div>
			</div>
