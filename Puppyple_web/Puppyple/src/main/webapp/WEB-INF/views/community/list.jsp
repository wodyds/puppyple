...
<body>
	<div id="content_wrap">
		...
		<div id="community_menubar">
			<ul>
				<li><a href="list.com" class="on_listpage">자유게시판</a></li>
			...
			<div class="title_div">
				<h1 class="title">
					자유게시판<span class="small_title"><span class="small_title_l">|</span>
						community</span>
				</h1>
			</div>
		</div>

		<form action="list.com" method="post">
					...
					<div id="search">
						<ul class="search_wrap">
							...
							<li class="search_eg2"><input type="text" id="keyword"
								name="keyword" value="${page.keyword }"> <a
								class="btn-fill" onclick="$('form').submit()">검색</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="list-content">
					...
					<c:forEach items="${page.list}" var="vo">
						<ul>
							...
							<li class="w-pct50" style="text-align: left; padding-left: 70px;">
								<a href='detail.com?id=${vo.id }'>${vo.board_title }</a>
							</li>
		...
		<c:if test="${! empty loginInfo }">
			<div class="writing">
				<ul class="writing_wrap">
					<li><a href='new.com' class="btn-fill">글쓰기</a></li>
				</ul>
			</div>
		</c:if>
