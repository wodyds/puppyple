		...
		<div class="board_content_wrap">
			...
			<c:if test="${ not empty vo.board_filename }">
				<div class="board_filename_c">${vo.board_filename }<a
						href="download.com?id=${vo.id }" style="margin-left: 9px;"><i
			...
			<div class="button comment_div">
				...
				<div class="list_btn2">
					<c:if
						...
						<a class="btn-fill"
							onclick=" $('form').attr('action', 'modify.com'); $('form').submit()">글
							수정</a>
						<a class="btn-fill" id="btn-delete"
							onclick=" if(confirm('정말 삭제하시겠습니까?')) { href='delete.com?id=${vo.id }'} ">글
							삭제</a>
					</c:if>
				</div>
