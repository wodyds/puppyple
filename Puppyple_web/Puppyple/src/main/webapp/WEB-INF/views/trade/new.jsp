...
<body>
	<div id="new_content_wrap">
		...
		<form action="insert.tra" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<th>제목</th>
					<td><div class="new_title_wrap">
							<input type="text" name='board_title' title='제목' class='chk'
								id="board_title" maxlength="100" autofocus /> <input type="text"
				...
				<tr>
					...
					<td class='left'><label> <a><img
								...
								style="padding-left: 2px;"></a> <input type="file"
		...
		<div class="button">
			...
			<a class='btn-empty' href='list.tra'>취소</a>
		</div>
